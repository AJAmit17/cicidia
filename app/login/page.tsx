                ...
                <form onSubmit={(e) => e.preventDefault()}>
                    <div>
                        ...
                        <Input
                            type="email"
                            required
                            className="w-full mt-2 px-3 py-4 text-primary bg-transparent outline-none  focus:border-pink-600/50 shadow-sm rounded-lg border-white/20 border-[1px]"
                        />
                    </div>
                    <div>
                    ...
                    <button className="w-full mt-4 group px-4 py-4 font-geist tracking-tighter text-xl text-white font-medium bg-purple-200/10 transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#8686f01f_inset] hover:bg-transparent/10 active:bg-purple-600 rounded-lg duration-150">
                        <Link href="/" >
                            Log in
                        </Link>
...
const SocialLoginButton: React.FC<SocialLoginButtonProps> = ({ provider }) => {
    ...
    return (
        <button className="group w-full space-x-1 py-3 flex transform-gpu dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#8686f01f_inset] border-white/10 items-center justify-center border rounded-lg hover:bg-transparent/20 duration-150 active:bg-transparent/50">
            <span className="w-5 h-5 mr-2">{getIcon()}</span>
